...
// ── Comprehensive settings for all page types ─────────────────────────────────

export const PRODUCT_SETTINGS = [
  {type:"header",content:"🎨 Brand Colors"},
  {type:"color",id:"color_accent",label:"Accent / CTA Color",default:"#C17F5E"},
  {type:"color",id:"color_bg",label:"Page Background",default:"#FFFDF9"},
  ...
  {type:"color",id:"announcement_bg",label:"Bar Background",default:"#1a1a1a"},
  ...
  {type:"checkbox",id:"show_tax_info",label:"Show Tax Info (incl. taxes)",default:true},
  {type:"text",id:"tax_info_text",label:"Tax Info Text",default:"Inclusive of all taxes"},

  {type:"header",content:"🎛️ Variants"},
  {type:"select",id:"variant_style",label:"Variant Button Style",options:[{value:"buttons",label:"Pill Buttons"},{value:"dropdown",label:"Dropdown Select"},{value:"swatches",label:"Color Swatches"}],default:"buttons"},
  ...
  {type:"header",content:"🛒 Quantity & Add to Cart"},
  ...
  {type:"number",id:"max_quantity",label:"Maximum Quantity (0 = unlimited)",default:0},
  ...
  {type:"checkbox",id:"show_wishlist",label:"Show Wishlist / Save Button",default:true},
  ...
  {type:"text",id:"cod_text",label:"COD Text",default:"Cash on Delivery Available"},

  {type:"header",content:"🛡️ Trust Badges"},
  {type:"text",id:"trust_1",label:"Trust Badge 1 Text",default:"Authentic & Certified"},
  {type:"text",id:"trust_2",label:"Trust Badge 2 Text",default:"Free Delivery"},
  {type:"text",id:"trust_3",label:"Trust Badge 3 Text",default:"Easy 30-Day Returns"},
  {type:"text",id:"trust_4",label:"Trust Badge 4 Text",default:"Secure Checkout"},
  ...
  {type:"text",id:"highlight_4",label:"Highlight 4",default:""},
  ...
  {type:"textarea",id:"return_policy_text",label:"Return Policy Text",default:"We offer hassle-free 30-day returns. Products must be unused and in original packaging."},
  ...
  {type:"range",id:"related_count",label:"Number of Products to Show",min:2,max:8,step:2,default:4},
...
export const CART_SETTINGS = [
  {type:"header",content:"🎨 Brand Colors"},
  {type:"color",id:"color_accent",label:"Accent Color",default:"#C17F5E"},
  {type:"color",id:"color_bg",label:"Page Background",default:"#FAFAFA"},
  ...
  {type:"text",id:"empty_btn_text",label:"Empty Cart Button Text",default:"Continue Shopping"},
  ...
  {type:"text",id:"promo_placeholder",label:"Input Placeholder",default:"Enter discount code"},
...
export const COLLECTION_SETTINGS = [
  ...
  {type:"color",id:"banner_bg_color",label:"Banner Background Color (fallback)",default:"#1a1a1a"},
  ...
  {type:"text",id:"empty_btn_text",label:"Empty State Button Text",default:"Browse All Products"},
  ...
  {type:"text",id:"promo_banner_text",label:"Promo Banner Text",default:"LIMITED TIME: Extra 10% off everything — Use code EXTRA10"},
  {type:"url",id:"promo_banner_link",label:"Promo Banner Link"},
  {type:"color",id:"promo_banner_bg",label:"Promo Banner Background",default:"#C17F5E"},
  {type:"color",id:"promo_banner_text_color",label:"Promo Banner Text Color",default:"#ffffff"},
];

// Write schemas as JSON for use in build script
fs.writeFileSync(
  path.resolve('./settings-schemas.json'),
  JSON.stringify({ PRODUCT_SETTINGS, CART_SETTINGS, COLLECTION_SETTINGS }, null, 2)
);
console.log('✅ settings-schemas.json written');
console.log(`  Product settings: ${PRODUCT_SETTINGS.length} items`);
console.log(`  Cart settings:    ${CART_SETTINGS.length} items`);
console.log(`  Collection settings: ${COLLECTION_SETTINGS.length} items`);
