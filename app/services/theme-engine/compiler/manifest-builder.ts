...
export class ManifestBuilder {
  ...
  private buildUploadBundle(input: ManifestBuilderInput): UploadBundle {
    ...
    return {
      ...
      // Hardcode common templates that compiler manages or extract from deps if supported
      templates: ["templates/index.json", "templates/product.json", "templates/collection.json"].sort(),
