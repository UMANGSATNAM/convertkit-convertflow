...
export const PAGES: PageDefinition[] = [
  ...
  // ── Collection Pages (10 Handmade Collection Designs) ─────────────────
  {
    id: "coll-lumiere-organic",
    name: "LUMIÈRE Organic Skincare Collection",
    pageType: "collection",
    niche: "Beauty & skincare",
    description: "Multi-filter sidebar, clean product grid with hover swatches, USP badges, and reviews.",
    sections: ["cp-v1", "hp1-fresh-usp-bar", "hp1-fresh-featured-products", "hp1-fresh-faq-accordion", "hp1-fresh-newsletter"],
  },
  {
    id: "coll-volt-streetwear",
    name: "VOLT Heavyweight Drop Collection",
    pageType: "collection",
    niche: "Streetwear & Activewear",
    description: "Dark streetwear grid with instant quick-add, size filters, ticker marquee, and drop FAQ.",
    sections: ["cp-v2", "hp2-marquee", "hp2-bestsellers", "hp2-faq", "hp2-newsletter"],
  },
  {
    id: "coll-nova-cyber",
    name: "NOVA High-Tech Audio Catalog",
    pageType: "collection",
    niche: "Tech & Audio",
    description: "Apple-style glassmorphism collection layout with specs comparison, tag filters, and newsletter.",
    sections: ["cp-v3", "hp3-marquee", "hp3-bestsellers", "hp3-faq", "hp3-newsletter"],
  },
  {
    id: "coll-aura-wellness",
    name: "AURA Clinical Wellness Catalog",
    pageType: "collection",
    niche: "Health & Supplements",
    description: "Clean medical-grade layout with benefit filters, doctor recommendation callouts, and trust grid.",
    sections: ["cp-v4", "hp4-bestsellers", "hp4-faq", "hp4-newsletter"],
  },
  {
    id: "coll-rawblox-urban",
    name: "RAWBLOX Urban Drop Grid",
    pageType: "collection",
    niche: "Streetwear",
    description: "Industrial drop grid with stock urgency counters, category pills, and brand story banner.",
    sections: ["cp-v5", "hp51-marquee", "hp51-trust-grid", "hp51-newsletter"],
  },
  {
    id: "coll-nordic-homeware",
    name: "NORDIC Minimalist Catalog",
    pageType: "collection",
    niche: "Home & Living",
    description: "Spacious Scandinavian catalog layout with material filters, dual view options, and FAQs.",
    sections: ["cp-v6", "hp6-bestsellers", "hp6-faq", "hp6-newsletter"],
  },
  {
    id: "coll-caratlane-luxury",
    name: "CARATLANE Fine Jewelry Collection",
    pageType: "collection",
    niche: "Jewelry & Luxury",
    description: "Luxury gold & gemstone collection layout with karat filters, try-at-home badge, and reviews.",
    sections: ["cp-v7", "hp10-collection-list", "hp10-faq", "hp10-newsletter"],
  },
  {
    id: "coll-artisanal-gourmet",
    name: "ARTISANAL Gourmet & Roastery Grid",
    pageType: "collection",
    niche: "Food & Beverage",
    description: "Warm craft roastery catalog with flavor profile filters, roast notes, and subscriber discounts.",
    sections: ["cp-v14", "hp14-collection-list", "hp14-faq", "hp14-newsletter"],
  },
  {
    id: "coll-performance-gear",
    name: "PERFORMANCE Activewear Catalog",
    pageType: "collection",
    niche: "Sports & Activewear",
    description: "High-density activewear catalog with compression filters, color swatches, and quick add.",
    sections: ["cp-v55", "hp11-collection-list", "hp11-faq", "hp11-newsletter"],
  },
  {
    id: "coll-vintage-denim",
    name: "VINTAGE Denim & Heritage Grid",
    pageType: "collection",
    niche: "Apparel & Outerwear",
    description: "Rustic denim catalog layout with wash filters, fit guide modal, and heritage trust seals.",
    sections: ["cp-v8", "hp11-collection-list", "hp11-faq", "hp11-newsletter"],
  },

  // ── Cart & Cart Drawer Pages (5 High-CRO Slide Cart Drawers) ───────────
  {
    id: "cart-drawer-pro",
    name: "PRO High-CRO Slide Cart Drawer",
    pageType: "cart",
    niche: "High-Converting D2C",
    description: "Dynamic free shipping progress bar, tier rewards unlocker, cross-sell upsell carousel, and 1-click checkout.",
    sections: ["cdr-v1", "hp1-fresh-usp-bar", "hp1-fresh-featured-products", "hp1-fresh-faq-accordion"],
  },
  {
    id: "cart-drawer-rewards",
    name: "REWARDS & Gift Counter Cart Drawer",
    pageType: "cart",
    niche: "Beauty & Skincare",
    description: "Interactive free gift threshold meter, sample add-ons, order note field, and trust badges.",
    sections: ["cdr-v2", "hp2-usp", "hp2-bestsellers", "hp2-faq"],
  },
  {
    id: "cart-drawer-countdown",
    name: "URGENCY Timer & Bundle Cart Drawer",
    pageType: "cart",
    niche: "Streetwear & Drop Releases",
    description: "15-minute item reservation timer, promo code applicator, sticky checkout CTA, and FAQs.",
    sections: ["cdr-v3", "hp3-marquee", "hp3-bestsellers", "hp3-faq"],
  },
  {
    id: "cart-drawer-minimal",
    name: "NORDIC Minimalist Slide Cart",
    pageType: "cart",
    niche: "Lifestyle & Apparel",
    description: "Sleek Scandinavian slide cart drawer with quantity steppers, subtotal breakdown, and express pay.",
    sections: ["cdr-v4", "hp6-bestsellers", "hp6-faq"],
  },
  {
    id: "cart-drawer-vip",
    name: "VIP Club & Gift Wrap Cart Drawer",
    pageType: "cart",
    niche: "Jewelry & Luxury",
    description: "Gift wrap option toggle, VIP discount code input, money-back guarantee, and security trust seals.",
    sections: ["cdr-v5", "hp51-trust-grid", "hp51-newsletter"],
  },
];
