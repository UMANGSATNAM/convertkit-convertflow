...
const INTEGRATIONS = [
  ...
  },
  {
    ...
    desc: "Send ConvertFlow interaction events to GA4 for cross-platform attribution.",
    status: "connect",
    color: "#F9AB00",
    ...
    <Page>
      ...
      <div className="st-wrapper">
        ...
        {activeTab === "Integrations" && (
          <div className="st-section">
            <p className="st-section-desc">Connect third-party tools to extend ConvertFlow's capabilities across your marketing stack.</p>
          ...
          <div className="st-section">
            ...
            {[
              ...
              },
              {
                ...
                price: "$19",
                period: "/mo",
                features: ["All 30+ sections", "All 3 themes", "Urgency tools (5 types)", "AI review writing", "Upsell engine", "ConvertFlow code extraction", "Unlimited events"],
                action: upgradeToPro,
                highlight: true,
              },
              {
