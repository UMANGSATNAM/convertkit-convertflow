...
const DEFAULT_SETTINGS = {
  ...
  hero_h1: "",
  hero_sub:
    "Discover our curated collection — crafted with quality you can feel.",
  hero_cta: "Shop Now",
  hero_cta2: "",
    ...
    <div style={{ minHeight: "100vh", background: "#f4f5f7" }}>
      ...
      <div style={{ padding: "24px", maxWidth: 1400, margin: "0 auto" }}>
        ...
        >
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <span style={{ fontSize: 12, color: "#888", fontWeight: 400 }}>
                Customize text, colors & content before injecting
              </span>
            </div>
            <span
              style={{
          ...
          {showSettings && (
            <div
              style={{ padding: "0 28px 28px", borderTop: "1px solid #f0f0f0" }}
            >
              <div
                style={{
                  display: "grid",
              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setSetting("hero_tag", e.target.value)}
                    style={{
                      width: "100%",
                      padding: "10px 14px",
                      border: "1.5px solid #e5e7eb",
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={settings.hero_h1}
                    onChange={(e) => setSetting("hero_h1", e.target.value)}
                    style={{
                      width: "100%",
                      padding: "10px 14px",
                      border: "1.5px solid #e5e7eb",
                ...
                <div style={{ gridColumn: "1 / -1" }}>
                  ...
                  <textarea
                    ...
                    onChange={(e) => setSetting("hero_sub", e.target.value)}
                    rows={2}
                    style={{
                      width: "100%",
                      padding: "10px 14px",
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setSetting("hero_cta", e.target.value)}
                    style={{
                      width: "100%",
                      padding: "10px 14px",
                      border: "1.5px solid #e5e7eb",
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={settings.hero_cta2}
                    onChange={(e) => setSetting("hero_cta2", e.target.value)}
                    style={{
                      width: "100%",
                      padding: "10px 14px",
                      border: "1.5px solid #e5e7eb",
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={settings.prod_heading}
                    onChange={(e) => setSetting("prod_heading", e.target.value)}
                    style={{
                      width: "100%",
                      padding: "10px 14px",
                      border: "1.5px solid #e5e7eb",
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={settings.prod_sub}
                    onChange={(e) => setSetting("prod_sub", e.target.value)}
                    style={{
                      width: "100%",
                      padding: "10px 14px",
                      border: "1.5px solid #e5e7eb",
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={settings.nl_h}
                    onChange={(e) => setSetting("nl_h", e.target.value)}
                    style={{
                      width: "100%",
                      padding: "10px 14px",
                      border: "1.5px solid #e5e7eb",
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={settings.nl_sub}
                    onChange={(e) => setSetting("nl_sub", e.target.value)}
                    style={{
                      width: "100%",
                      padding: "10px 14px",
                      border: "1.5px solid #e5e7eb",
                ...
                >
                  ...
                  <span>
                    These settings will be pre-filled in the Shopify Theme
                    Editor after injection. You can change any value there too —
                    including colors, images, and product collections.
                  </span>
                </div>
              </div>
            </div>
        ...
        >
          <div>
            ...
            >
              Ready to inject{" "}
              <span style={{ color: currentTpl?.accent }}>
                {currentTpl?.name}
              </span>{" "}
              template
            </div>
            <p style={{ fontSize: 13, color: "#888" }}>
              This will push Landing Page + Product Page + Cart Page +
              Collection Page into your active Shopify theme.
            </p>
          </div>
          <button
            ...
            style={{
              background: isInjecting
                ? "#999"
                : `linear-gradient(135deg, ${currentTpl?.accent}, ${currentTpl?.accent}cc)`,
        ...
        {injectResult?.success && (
          ...
          >
            ...
            >
              {icon("check")} {injectResult.templateLabel} — 3 pages injected
              into &quot;{injectResult.themeName}&quot;!
            </div>
