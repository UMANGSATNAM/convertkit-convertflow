...
export const STORE_PAGE_TEMPLATES: StorePageTemplate[] = [
  ...
  },
  {
    ...
    styleTag: "✨ Pure White & Botanical Cyan",
    accentColor: "#0284c7",
    description: "10X Biossance & Paula's Choice benchmark: pure white background, squalane & vitamin C active matrix, clinical dermatologist trials, shoppable reels, and clean formula transparency.",
    heroImg: "https://images.unsplash.com/photo-1556228720-195a672e8a03?w=800&q=80",
    badge: "🔬 100% CLEAN FORMULA CERTIFIED",
    usageCount: "Used on 9,120 Beauty D2C stores",
    announcement: "caratlane-announcement",
    header: "caratlane-header",
    footer: "caratlane-footer",
    sections: [
