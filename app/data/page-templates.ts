...
export const STORE_PAGE_TEMPLATES: StorePageTemplate[] = [
  ...
  },
  {
    ...
    styleTag: "🔥 Dark Obsidian & Electric Orange",
    accentColor: "#ff5500",
    description: "10X Fear of God & Kith benchmark: 450GSM French Terry fabric specs matrix, interactive outfit lookbook hotspots, size selector quick-add, and VIP drop access.",
    heroImg: "https://images.unsplash.com/photo-1523381210434-271e8be1f52b?w=800&q=80",
    badge: "🔥 450GSM HEAVYWEIGHT COTTON",
    usageCount: "Used on 8,450 Apparel D2C stores",
    announcement: "caratlane-announcement",
    header: "caratlane-header",
    footer: "caratlane-footer",
    sections: [
