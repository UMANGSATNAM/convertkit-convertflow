...
- **Rule 7:** Read-only or not, no live API call before the user's explicit trigger phrase. (Incident #6 logged: self-granting authorization to run live GraphQL introspection without user's explicit trigger phrase).
- **Status:** **LOCKED**
